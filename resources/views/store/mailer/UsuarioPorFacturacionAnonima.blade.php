                                                ...
                                                <tr>
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                            <tr>
                                                                <td align="left">
                                                                    <p style="color: #020202">Gracias por comprar nuestros productos en nuestra tienda online a partir de este momento nuestro tienda lo a pre-registrado.<br>
                                                                    Usuario: <b>{{$usuario}}</b>
                                                                    <br></p>
                                                                </td>
                                                            </tr>
                                            ...
                                            <table cellpadding="0" cellspacing="0" class="es-right" align="right">
                                                <tr>
                                                    <td width="270" align="left">
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                            <tr>
                                                                <td align="center"><span class="es-button-border" style="border-width: 0px;border-radius: 7px;background: #999999;border-color: #2cb543"><a href="" class="es-button" target="_blank" style="font-size: 14px;border-radius: 7px;font-weight: normal;background: #999999;border-color: #999999;color: #000000">{{$clave}}</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                    ...
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                            <tr>
                                                                <td align="left">
                                                                    <p>
                                                                        Si desea ingresar al sistema, de clic en el siguiente boton. <br/>(Una vez ingrese, <i>se recomienda cambiar la contraseña)</i></p>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                            <tr>
                                                                <td align="center"><span class="es-button-border" style="border-width: 0px;border-radius: 7px;background: #dc97aa;border-color: #2cb543"><a href="https://elescaparatedelolita.com/" class="es-button" target="_blank" style="font-size: 14px;font-weight: normal;border-radius: 7px;background: #dc97aa;border-color: #dc97aa">Ingresar</a></span></td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td width="560" align="center" valign="top">
                                                        <table cellpadding="0" cellspacing="0" width="100%" role="presentation">
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <p style="line-height: 120%;color: #090909">Contáctanos +507 388-8936 / +507 6324-9894 /&nbsp;Calle 71 Casa No 97 San Francisco Panamá&nbsp;/e-mail:<a href="mailto:info@elescaparatedelolita.com">info@elescaparatedelolita.com</a>&nbsp;</p>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td align="center" class="es-p10t" style="font-size:0">
