												...
												<tr>
													<td width="560" align="center" valign="top">
														<table cellpadding="0" cellspacing="0" width="100%" role="presentation">
															<tr>
																<td align="center">
																	<p style="font-size: 25px;color: #ffffff"><strong>Se ha confirmado tu cita</strong></p>
																</td>
															</tr>
														</table>
													</td>
												...
												<tr>
													<td width="560" align="center" valign="top">
														<table cellpadding="0" cellspacing="0" width="100%" role="presentation">
															<tr>
																<td align="left">
																	<p>Hola <b>{{$nombres}}</b><br/> 
																	Hemos aceptado su solicitud y su cita ha sido agendada:
																	<br/><br/>
																	<b>Tipo Agenda:</b> {{$tipoAgenda}}<br/>
																	@if($producto != "")
																	<b>Producto:</b>{{$producto}}<br/>	@endif						
																	<b>Fecha:</b> {{$fecha}}<br/>
													...
													<td width="560" align="center" valign="top">
														<table cellpadding="0" cellspacing="0" width="100%" role="presentation">
															<tr>
																<td align="left">
																	<p>
																		Si tienes inconvenientes con la cita realiza, comunicate con nosotros.
																	</p>
																</td>
															</tr>
															<tr>
