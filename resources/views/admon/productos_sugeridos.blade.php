...
@section('titulo')
<title>Productos Sugeridos - Administración Escaparate</title>
@endsection
...
@section('page-header')
						...
						<div class="page-header">
							<h1 class="page-title"> Productos Sugeridos - Destacados</h1>
						</div>
						<!-- End page-header -->
@endsection
@section('content')
						
							<div class="row" id="App_Admon_Productos_Sugeridos">
