...
@section('titulo')
<title>Configuraciones Generales - Administración Escaparate</title>
@endsection
...
@section('page-header')
        <div class="page-header">
            <h1 class="page-title"> Configuraciones Generales</h1>
        </div>
@endsection
@section('content')
        <div class="row" id="App_Admon_Settings_Enviroment">
