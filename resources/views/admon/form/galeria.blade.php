...
@section('titulo')
<title>{{($token_editing) == "" ? "Nueva" : "Actualizar"}} Imagen Gallery - Administración Escaparate</title>
@endsection
...
@section('page-header')
						...
						<div class="page-header">
							<h1 class="page-title">{{($token_editing) == "" ? "Nueva" : "Actualizar"}} Imagen Gallery</h1>
						</div>
						<!-- End page-header -->
@endsection
@section('content')
							...
							<div class="row" id="App_Admon_Form_Galeria">
