...
@section('titulo')
<title>Tags - Administración Escaparate</title>
@endsection
						...
						<div class="page-header">
							...
							<div class="ml-auto">
								<div class="input-group">
									<a href="{{ url('/' . $page='admon/add/tag') }}" class="btn btn-info btn-icon mr-2" data-toggle="tooltip" title="" data-placement="bottom" data-original-title="Agregar Nuevo">
										<span>
