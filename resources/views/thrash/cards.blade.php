						...
						<div class="row">
							...
							<div class="col-md-12 col-lg-4">
								<div class="card text-white bg-gradient-primary">
									<div class="card-body">
										<h4 class="card-title">Gradient Primary card title</h4>
										<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
									</div>
								</div>
							</div>
						...
						<div class="row">
							...
							<div class="col-md-12 col-xl-4">
								<div class="card">
									...
									<div class="card-body">
                                          The most well-known dummy text is the 'Lorem Ipsum', which is said to have originated in the 16th century. Lorem Ipsum is composed in a pseudo-Latin language which more or less corresponds to 'proper' Latin</div>
									<div class="card-footer bg-info br-br-7 br-bl-3">
							...
							<div class="col-md-12  col-xl-4">
								<div class="card">
									<div class="card-header">
										...
										<div class="card-options">
											<a href="#" class="card-options-collapse" data-toggle="card-collapse"><i class="fe fe-chevron-up"></i></a>
											<a href="#" class="card-options-fullscreen ml-2 mr-2" data-toggle="card-fullscreen"><i class="fe fe-maximize"></i></a>
											<a href="#" class="card-options-remove" data-toggle="card-remove"><i class="fe fe-x"></i></a>
										</div>
									</div>
									<div class="card-body">
