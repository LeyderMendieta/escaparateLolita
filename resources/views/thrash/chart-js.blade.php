						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<canvas id="sales-chart" class=" h-200"></canvas>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<canvas id="team-chart" class=" h-200"></canvas>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
							...
							<div class="col-lg-6 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<canvas id="radarChart" class=" h-200"></canvas>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
							...
							<div class="col-lg-6 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<canvas id="doughutChart" class=" h-200"></canvas>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<canvas id="pieChart" class=" h-200"></canvas>
									</div>
								</div>
							</div>
							<div class="col-lg-6 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<canvas id="polarChart" class="h-200"></canvas>
									</div>
								</div>
							</div>
						</div>
