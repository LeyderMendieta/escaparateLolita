...
@section('page-header')
						...
						<div class="page-header">
							<h1 class="page-title"> Nvd3 Chart</h1>
							<div class="ml-auto">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<div id="nvd3-chart1" class="chartsh"> <svg></svg></div>
									</div>
								</div>
							</div>
							<div class="col-lg-12 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										<svg id="nvd3-chart2" class="chartsh"></svg>
									</div>
								</div>
							</div>
							<div class="col-lg-12 col-md-12">
								<div class="card">
									...
									<div class="card-body">
										...
										<div id="nvd3-chart3" class="with-transitions chartsh">
											<svg></svg>
										</div>
									</div>
								</div>
